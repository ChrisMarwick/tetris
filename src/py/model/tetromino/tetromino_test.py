...
class TestTetromino:
    ...
    def test_move_down(self):
        ...
        assert not grid.is_cell_occupied(0, 2)
        assert not grid.is_cell_occupied(0, 3)
        assert not grid.is_cell_occupied(0, 4)
        assert grid.is_cell_occupied(1, 1)
        assert grid.is_cell_occupied(1, 2)
        assert grid.is_cell_occupied(1, 3)
    ...
    def test_move_down_blocked(self):
        ...
        with pytest.raises(MovementBlocked):
            tetromino.move_down()
        assert grid.is_cell_occupied(0, 1)
        assert grid.is_cell_occupied(0, 2)
        assert grid.is_cell_occupied(0, 3)
        assert grid.is_cell_occupied(0, 4)
        assert not grid.is_cell_occupied(1, 1)
        assert not grid.is_cell_occupied(1, 2)
        assert not grid.is_cell_occupied(1, 3)
        assert grid.is_cell_occupied(1, 4)
    ...
    def test_rotate_anticlockwise(self):
        ...
        assert not grid.is_cell_occupied(2, 1)
        assert not grid.is_cell_occupied(2, 3)
        assert not grid.is_cell_occupied(2, 4)
    ...
    def test_rotate_blocked_bottom(self):
        ...
        assert not grid.is_cell_occupied(0, 2)
        assert not grid.is_cell_occupied(1, 2)
        assert not grid.is_cell_occupied(3, 2)
    ...
    def test_drop_blocked_1(self):
        ...
        assert grid.is_cell_occupied(3, 4)
        assert not grid.is_cell_occupied(0, 1)
        assert not grid.is_cell_occupied(0, 2)
        assert not grid.is_cell_occupied(0, 3)
        assert not grid.is_cell_occupied(0, 4)
    ...
    def test_drop_blocked_bottom(self):
        ...
        assert grid.is_cell_occupied(4, 4)
        assert not grid.is_cell_occupied(0, 1)
        assert not grid.is_cell_occupied(0, 2)
        assert not grid.is_cell_occupied(0, 3)
        assert not grid.is_cell_occupied(0, 4)